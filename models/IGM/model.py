...
class Net(nn.Module):
    ...
    def forward(self, data_dict, **kwargs):
        ...
        folding_src[key_mask_src.unsqueeze(-1)] = folding_src.mean(-2, keepdim=True).unsqueeze(-2)
        folding_tgt[key_mask_tgt.unsqueeze(-1)] = folding_tgt.mean(-2, keepdim=True).unsqueeze(-2)
