...
from models.IGM.model import Net as Backbone
...
class Net(nn.Module):
    def __init__(self):
        ...
        self.message_pass_node_features = SiameseSConvOnNodes(input_node_dim=256)
    ...
    def forward(
        ...
        for feat, glob, n_p, graph in zip(data_dict['rf'], data_dict['gf'], n_points, graphs):
            ...
            node_features = concat_features(feat, n_p)
