        ...
        for keys in ids:
            ...
            with Image.open(str(img_file)) as img:
                ...
                if self.sets != 'test':
                    ...
                    x, y, x2, y2 = ((numpy.random.random([4]) - 0.1) * rand_factor * [-1, -1, 1, 1]).astype(numpy.int32)
                    ...
                    for kpt in obj_dict['kpts']:
                        ...
                        kpt['y'] = kpt['y'] / self.obj_resize[1] * h + ymin
                        kpt['x'] = (kpt['x'] - xminn) * self.obj_resize[0] / (xmaxn - xminn)
