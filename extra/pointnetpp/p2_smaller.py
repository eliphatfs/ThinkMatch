...
class get_model(nn.Module):
    def __init__(self, additional_channel, g_channel):
        ...
        self.sa1 = PointNetSetAbstractionMsg(24, [0.1, 0.2, 0.4], [24, 24, 24], 3 + additional_channel, [[64, 128], [128, 256], [64, 128]])
        self.sa3 = PointNetSetAbstraction(npoint=None, radius=None, nsample=None, in_channel=512 + 3, mlp=[256, 1024], group_all=True)
        self.fp3 = PointNetFeaturePropagation(in_channel=1024 + 128 + 256, mlp=[1024, 512])
